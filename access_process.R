...
process_data <- function(access_data){
  ...
  original.cols <- c("DEP_RPT_GRP_SEVENTEEN","DEPT_SPECIALTY_NAME","DEPARTMENT_NAME","PROV_NAME_WID", "DEPARTMENT_ID",
                     ...
                     "PRIMARY_DX_CODE", "ENC_CLOSED_CHARGE_STATUS", "Y_ENC_COSIGN_TIME", "Y_ENC_CLOSE_TIME", "Y_ENC_OPEN_TIME", "NPI", "PAT_ENC_CSN_ID", "VISITPLAN")
...
historical.data <- data.subset.new 
