...
historical_prev <- readRDS("/data/Ambulatory/Data_Updated/historical_data.rds")
...
saveRDS(historical.data, "/data/Ambulatory/Data_Updated/historical_data.rds")
rm(historical_prev)

pop_prev <- readRDS("/data/Ambulatory/Data_Updated/population_data.rds")
...
saveRDS(population.data_filtered, "/data/Ambulatory/Data_Updated/population_data.rds")
rm(pop_prev)

utilization_prev <- readRDS("/data/Ambulatory/Data_Updated/utilization_data.rds")
...
saveRDS(utilization.data, "/data/Ambulatory/Data_Updated/utilization_data.rds")
rm(utilization_prev)

holid_prev <- as.data.frame(read_feather("/data/Ambulatory/Data_Updated/holid.feather"))
holid <- bind_rows(holid_prev,holid)
write_feather(holid, "/data/Ambulatory/Data/Data_Updated.feather")
#}
